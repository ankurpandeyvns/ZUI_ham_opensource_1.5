...
extern void msm8974_typec_usb_set(bool en1,  bool en2);
extern int msm8974_anc_headset_set(unsigned int arg);
			    ...
			    unsigned int cmd, unsigned long arg)
{
	...
	switch(cmd)
	{
		...
		case ANC_HEADSET_SET:
		{
			return msm8974_anc_headset_set(arg); 
			break;
		}
