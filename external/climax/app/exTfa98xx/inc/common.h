...
// tfa device slave address of 1st (=left) device
...
#define TFA98XX_NOMINAL_IMPEDANCE         (6.5)
#define TFA98XX_NOMINAL_IMPEDANCE_MIN     (TFA98XX_NOMINAL_IMPEDANCE*0.8)
#define TFA98XX_NOMINAL_IMPEDANCE_MAX     (TFA98XX_NOMINAL_IMPEDANCE*1.2)
